...
const ALL_COUNTRY_DATA = {
  war: {
    ...
    "643":{name:"🇷🇺 RUSIA ⚠️",fecha:"20 MAR",c:"#ff4400",det:"DÍA 11 — Putin habló con Trump sobre Irán y Ucrania. Rusia da a Irán coordenadas de buques de guerra y aviones de EE.UU. en el Medio Oriente. Confirmado por 3 fuentes de inteligencia occidentales. Triple beneficio: ingresos energéticos récord, distracción militar occidental, menos ayuda a Ucrania."},
