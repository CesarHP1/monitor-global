// @ts-nocheck
// MONITOR GLOBAL v11 — 13 MAR 2026 — DÍA 14 — FULL INTERACTIVE
...
const TITLES = { war:"⚔️  CONFLICTOS GLOBALES — DÍA 14 — 13 MAR 2026", disease:"🦠  BROTES GLOBALES — OMS — 13 MAR 2026", climate:"🌍  CLIMA · SISMOS USGS · NOAA · NASA EONET", news:"📰  ECONOMÍA & MERCADOS — 13 MAR 2026" };
...
const MODE_VOICE = {
  war:"Conflictos globales. Día catorce de la guerra Irán, Estados Unidos e Israel. Mojtaba Jamenei, el nuevo Líder Supremo, emitió su primera declaración exigiendo el retiro de todas las bases militares estadounidenses de la región. Un avión cisterna militar de Estados Unidos se estrelló en Iraq matando a seis personas. Al menos mil cuatrocientas cuarenta y cuatro personas han muerto y dieciocho mil quinientas cincuenta y uno han resultado heridas. Alemania exige un plan convincente para terminar la guerra. El conflicto ya ha costado once punto tres mil millones de dólares en solo seis días.",
  ...
  news:"Modo economía. Día catorce. Costo de la guerra ya supera once punto tres mil millones de dólares. Doscientas cincuenta organizaciones en Estados Unidos firmaron carta al Congreso pidiendo detener el financiamiento. Estrecho de Ormuz sigue severamente perturbado empujando el petróleo al alza. Irán atacó petroleros e instalaciones en el Golfo. Alemania pide un plan convincente para terminar la guerra. El nuevo líder iraní advierte que los ataques continuarán mientras existan bases militares de EE.UU. en la región. Ahora, qué hacer con tu dinero en este momento. Petróleo y energía: comprar acciones de Exxon, Chevron o Petróleos Brasileños que suben con el Brent. Metales: oro y plata como refugio, ya en máximos históricos. En México: CETES al doce por ciento protegen tus ahorros de la inflación y la devaluación del peso. Evita cambiar dólares ahora con el peso en mínimos. Si tienes dólares, espera a que el tipo de cambio baje. Criptomonedas: Bitcoin sube en crisis pero con alta volatilidad, solo si tienes tolerancia al riesgo. Lo más seguro ahora mismo: CETES, oro, y acciones energéticas estadounidenses.",
};
...
const ALL_COUNTRY_DATA = {
  ...
  news: {
    "840":{name:"🇺🇸 EE.UU.",fecha:"13 MAR",c:"#ff6600",det:"DÍA 14 — Avión cisterna militar se estrelló en Iraq: 6 muertos. EE.UU. atacó una manifestación pro-gubernamental en Irán. 250+ organizaciones pidieron al Congreso detener el financiamiento ($11.3B en 6 días). Hegseth: nuevo líder iraní 'herido y desfigurado'. Aranceles 25% a Europa entraron en vigor el 15 de marzo. Mercados bajo presión máxima."},
    "364":{name:"🇮🇷 IRÁN",fecha:"13 MAR",c:"#ff4444",det:"DÍA 14 — Nuevo Líder Supremo Mojtaba Jamenei: ataques continuarán hasta cierre de bases de EE.UU. en la región. Internet apagado 350+ horas, récord mundial absoluto. 1,444+ muertos, 18,551+ heridos. Irán atacó petroleros e instalaciones en el Golfo. Estrecho de Hormuz severamente perturbado."},
    ...
    "276":{name:"🇩🇪 ALEMANIA",fecha:"13 MAR",c:"#4488ff",det:"DÍA 14 — Alemania exige un 'plan convincente' para terminar la guerra. Merz negocia coalición CDU. Recesión técnica por doble golpe: aranceles Trump 25% + crisis energética por Ormuz bloqueado. DAX cayó 11% desde inicio del conflicto. Exportaciones de manufactura en riesgo crítico."},
    ...
    "484":{name:"🇲🇽 MÉXICO",fecha:"13 MAR",c:"#ffaa44",det:"DÍA 14 — Cuádruple crisis: petróleo >$90 (+22% gasolina), peso >18.5/USD en mínimos, aranceles 35% Trump, sarampión activo en 7 estados. Ormuz perturbado impacta precios energéticos. FMI: recesión Q3 si la guerra dura más de 4 semanas. Banco de México intervino en mercado de divisas."},
...
// ═══════════════════════════════════════════════════════════════════
const BASE_WAR = [
  {id:"usa",name:"EE.UU.",lat:38,lng:-97,c:"#ff2020",s:5,st:"guerra",conn:["iran"],fecha:"DÍA 14",det:"DÍA 14 — Avión cisterna militar estrellado en Iraq: 6 muertos. EE.UU. atacó manifestación pro-gubernamental en Irán. Costo total supera $11.3B. 250+ organizaciones piden al Congreso detener el financiamiento. Presión interna creciente."},
  {id:"iran",name:"IRÁN",lat:32.4,lng:53.7,c:"#ff1a1a",s:5,st:"guerra",conn:["israel","gulf"],fecha:"DÍA 14",det:"DÍA 14 — Mojtaba Jamenei: ataques continúan hasta que EE.UU. cierre bases en la región. 1,444+ muertos, 18,551+ heridos. Internet apagado 350+ horas. No apareció en persona — Hegseth: 'herido y desfigurado'."},
  {id:"israel",name:"ISRAEL",lat:31,lng:34.9,c:"#ff1a1a",s:5,st:"guerra",conn:["lebanon"],fecha:"DÍA 14",det:"DÍA 14 — Continúa operaciones en Líbano. Netanyahu evalúa con gabinete respuesta ante declaración del nuevo Líder Supremo iraní. Analiza ampliar objetivos a capacidades de misiles balísticos."},
  {id:"fordow",name:"FORDOW ☢️\n¡ATACADA!",lat:34.6,lng:51.1,c:"#ff0000",s:5,st:"critico",fecha:"DÍA 12",det:"FORDOW ATACADA DÍA 12 — Primera vez en la historia. Israel usó GBU-57 a 80m de profundidad. IAEA confirmó daños. Nuevo Líder Supremo Mojtaba Jamenei: 'respuesta sin precedentes pendiente'. Enriquecimiento al 60% interrumpido. Brent subió $5 en minutos."},
  {id:"tanker_crash",name:"AVIÓN\n🇺🇸 IRAQ",lat:33.3,lng:44.4,c:"#ff4400",s:4,st:"critico",fecha:"DÍA 14",det:"DÍA 14 — Avión cisterna militar estadounidense se estrelló en Iraq matando a 6 personas. Causa bajo investigación. Tercer incidente de aviación militar en la zona desde el inicio del conflicto. Aumenta presión interna en EE.UU."},
  {id:"lebanon",name:"LÍBANO",lat:33.9,lng:35.5,c:"#ff4444",s:4,st:"guerra",fecha:"DÍA 14",det:"550+ muertos: 95+ niños, 55+ mujeres. Israel continúa atacando depósitos de armas Hezbollah. Fósforo blanco confirmado por HRW. CICR advierte colapso humanitario inminente."},
  ...
  {id:"russia",name:"RUSIA\n⚠️INTEL",lat:61.5,lng:105,c:"#ff4400",s:4,st:"activo",fecha:"13 MAR",det:"Sigue dando a Irán coordenadas de buques y aviones USA. Confirmado por inteligencia occidental. Ingresos energéticos récord. Aranceles Trump presionan economía pero la guerra los compensa."},
  ...
  {id:"gulf",name:"GOLFO\n🔴CRISIS",lat:24.5,lng:51.2,c:"#ff6600",s:5,st:"atacado",fecha:"13 MAR",det:"Irán atacó petroleros e instalaciones en el Golfo. Ormuz severamente perturbado. Bahrain BAPCO force majeure. Saudi Aramco cierra Ras Tanura. Qatar LNG fuerza mayor (20% gas mundial). 300+ petroleros atrapados."},
  {id:"ormuz",name:"ORMUZ\n-95% TRÁFICO",lat:26.6,lng:56.5,c:"#ff8800",s:5,st:"critico",fecha:"13 MAR",det:"Tráfico de petroleros cayó 95%. 300+ barcos atrapados. Irán continúa atacando barcos en el estrecho. Brent sube ante la perturbación continua. Citigroup: pérdida 7-11 millones barriles/día."},
  {id:"school",name:"ESCUELA\n168 NIÑAS",lat:27.5,lng:55,c:"#ff2200",s:5,st:"critico",fecha:"DÍA 12",det:"Strike del día 1 mató 168 niñas en escuela primaria en sureste de Irán. DÍA 12: Hegseth confirmó que fue un error de targeting. Pentágono tiene investigación formal abierta. Trump culpa a Irán por usar escuelas como escudo."},
  {id:"turkey",name:"TURQUÍA\n🛡️OTAN",lat:39,lng:35,c:"#ffcc00",s:3,st:"tension",fecha:"13 MAR",det:"DÍA 14 — Cumbre OTAN en Bruselas concluyó sin resolución concreta. Artículo 4 activo. Alemania exige plan convincente para terminar la guerra. Erdogan: mediación es la única salida viable."},
  {id:"china",name:"CHINA\n❌MEDIACIÓN",lat:35,lng:104,c:"#ffcc00",s:3,st:"tension",fecha:"13 MAR",det:"China propuso cese al fuego de 72 horas — rechazado por Trump. Sigue comprando petróleo iraní con descuento máximo. Aranceles 145% de EE.UU. más crisis energética: doble presión. Wang Yi en contacto permanente con todas las partes."},
];
...
const BASE_NEWS = [
  {id:"fordow_n",name:"NUEVO LÍDER\nIRÁN 🇮🇷",lat:34.6,lng:51.1,c:"#ff0000",s:5,st:"critico",icon:"☢️",fecha:"13 MAR",det:"DÍA 14 — Mojtaba Jamenei, nuevo Líder Supremo iraní, emitió primera declaración: los ataques continuarán hasta que EE.UU. cierre TODAS sus bases militares en la región. No apareció en persona. Hegseth: 'herido y probablemente desfigurado'. Primera declaración pública desde que asumió el poder."},
  {id:"oil",name:"ORMUZ\n⬆️BRENT",lat:26.6,lng:56.5,c:"#ffaa00",s:5,st:"critico",icon:"🛢️",fecha:"13 MAR",det:"Estrecho de Hormuz severamente perturbado. Irán atacó petroleros e instalaciones en el Golfo. Brent sube ante la crisis continua. Ormuz -95% tráfico. Qatar LNG force majeure. Saudi Aramco cierra Ras Tanura."},
  {id:"trump_xi",name:"GUERRA\n$11.3B COSTO",lat:38,lng:-97,c:"#ff6600",s:5,st:"critico",icon:"💸",fecha:"13 MAR",det:"DÍA 14 — El conflicto ya costó $11.3 mil millones en solo 6 días. 250+ organizaciones en EE.UU. firmaron carta al Congreso pidiendo detener el financiamiento. Presión política interna en aumento. Alemania también exige plan para terminar la guerra."},
  ...
  {id:"jobs",name:"PRESIÓN\nINTERNA USA",lat:40.7,lng:-74,c:"#ff3344",s:4,st:"activo",icon:"📉",fecha:"13 MAR",det:"DÍA 14 — 250+ organizaciones firmaron carta al Congreso pidiendo detener el financiamiento de la guerra ($11.3B en 6 días). Avión cisterna estrellado en Iraq: 6 muertos. Presión política interna en máximos desde inicio del conflicto. Mercados nerviosos ante escalada continua."},
  {id:"peso",name:"PESO MX\n>18.5/USD",lat:19.4,lng:-99.1,c:"#ffaa44",s:4,st:"activo",icon:"💱",fecha:"11 MAR",det:"Peso rebasa 18.5/USD tras Fordow. Gasolina +22%. Aranceles 35% Trump. FMI: recesión México Q3."},
  {id:"bapco",name:"BAHRAIN+QATAR\n🔴FORCE MAJ.",lat:26.2,lng:50.5,c:"#ff4444",s:4,st:"critico",icon:"🔥",fecha:"10 MAR",det:"BAPCO y Qatar LNG mantienen force majeure. 20% del gas mundial interrumpido. Ras Tanura cerrada. Ormuz -95%."},
...
export default function App(){
  ...
  return(
    <div style={{background:bg,minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",padding:"10px 8px 16px",fontFamily:"'Courier New',monospace",color:"#fff",transition:"background 0.6s",userSelect:"none",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{marginTop:"8px",fontSize:"6px",color:"rgba(255,255,255,0.07)",letterSpacing:"2px",textAlign:"center",position:"relative",zIndex:1}}>MONITOR GLOBAL v10 FULL · USGS · NOAA · OPEN-METEO · OPENSKY · NASA EONET · COINGECKO · FRANKFURTER · CLAUDE AI · 11 MAR 2026 · DÍA 12</div>
